        ...
        <div className="w-full  p-4 bg-white rounded-lg shadow-lg mb-6 lg:mb-0  ">
          ...
          <div className="mt-6 w-full md:px-6 sm:p-2  gap-x-8 flex flex-col lg:flex-row items-center lg:items-start justify-between">
            ...
            <div className="  md:w-2/3 sm:w-full">
              ...
              <p className="md:ml-8  md:w-11/12 sm:w-full flex justify-center border mt-16 mb-4 border-[#488b80c9]  items-center opacity-50">
              </p>
              ...
              <div className="flex flex-col md:flex-row flex-wrap md:flex-nowrap mb-4 gap-4 md:gap-8">
                ...
                <div className="flex justify-center items-center h-18 md:h-22">
                  <div className="border-t md:border-l md:border-t-0 border-black w-full md:w-auto h-full opacity-50">
                  </div>
                </div>
            ...
            <div className="w-full lg:w-1/3 p-4 bg-white rounded-lg shadow-lg  border border-[#4eac9c]">
              ...
              <p className=" md:w-11/12 sm:w-full flex justify-center border mb-4 border-[#488b80c9]  items-center md:ml-4 opacity-50">
              </p>
              <div className="mb-6 ">
              ...
              <p className=" md:w-3/4 sm:w-full flex justify-center border mb-4 border-[#488b80c9]  items-center md:ml-10 opacity-50">
              </p>
              <div className="ml-8">
              ...
              <p className=" md:w-3/4 sm:w-full flex justify-center border mb-4 border-[#488b80c9] mt-8 items-center md:ml-10 opacity-50">
              </p>
          ...
          <p className="md:ml-12  md:w-11/12 sm:w-full flex justify-center border mt-10 mb-4 border-[#488b80c9]  items-center opacity-50">
          </p>
            ...
            <div className="w-full p-4 md:p-8">
              ...
              <div className="flex flex-col md:flex-row mt-4 justify-between">
                <div className="flex flex-col w-full md:w-5/12 gap-y-4">
                  ...
                  <div className="border w-full border-[#488B80] mt-1 border-opacity-50 mb-2">
                  </div>
                  <div className="flex flex-row justify-between">
                    <p>Level</p>
                    <div className="flex flex-row gap-x-2">
                  ...
                  <div className="border w-full border-[#488B80] mt-1 border-opacity-50 mb-2 md:hidden sm:block">
                  </div>
                </div>

                {/* Vertical Line */}
                <div className="hidden md:flex justify-center items-center h-24">
                  <div className="border-l border-[#488B80] h-full opacity-50">
                  </div>
                </div>
