      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white shadow-md rounded-lg p-8">
            ...
            <button className="bg-[#41c396] text-white py-2 px-4 rounded-md hover:bg-[#3aa384]">Find Your Mentor</button>
          </div>
          {/* Step 2 */}
          <div className="bg-white shadow-md rounded-lg p-8">
            ...
            <button className="bg-[#41c396] text-white py-2 px-4 rounded-md hover:bg-[#3aa384]">Book a FREE Trial</button>
          </div>
          {/* Step 3 */}
          <div className="bg-white shadow-md rounded-lg p-8">
            ...
            <button className="bg-[#41c396] text-white py-2 px-4 rounded-md hover:bg-[#3aa384]">Start Preparing</button>
          </div>
        </div>
      </div>
    </div>
