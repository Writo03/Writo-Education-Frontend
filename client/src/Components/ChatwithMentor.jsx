      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {steps.map((step) => (
              <div key={step.step} className=" p-6 rounded-lg shadow-lg bg-[#184948] hover:bg-[#184948cf] transition duration-300">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {mentors.map((mentor, index) => (
              <div key={index} className="bg-[#184948] hover:bg-[#184948cf] p-6 rounded-lg shadow-lg transition duration-300">
                ...
                <button className="bg-[#1F5673] hover:bg-[#1f5673ce] text-white font-bold py-2 px-4 rounded mt-4 focus:outline-none focus:shadow-outline">
                  Chat Now
                </button>
              </div>
            ))}
        ...
        <div>
          ...
          <form className="bg-[#184948] p-6 rounded-lg shadow-lg">
            <div className="mb-4">
            ...
            <button className="bg-[#1F5673] hover:bg-[#1f5673ce] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
              Submit Query
            </button>
          </form>
        </div>
