  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 bg-white">
      ...
      <div className="flex flex-col lg:flex-row items-center w-full lg:w-4/5">
        <div className="lg:w-2/3 w-full mb-6 lg:mb-0 flex flex-col items-center">
          ...
          <p className="mb-4 text-lg text-gray-800 item2 text-center">
            Look no further! Writo Education offers a unique live doubt session
            program designed to address all your queries in real-time. Our
            platform connects you with experienced faculties from renowned
            institutions like IITs and NITs, ensuring personalized guidance and
