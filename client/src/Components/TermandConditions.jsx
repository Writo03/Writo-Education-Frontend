  ...
  return (
    <div>
       <div>
            ...
            <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md py-6">
                <h1 className="text-center text-3xl font-bold mb-6 text-[#184948]">Terms and Conditions</h1>
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">2. Intellectual Property Rights</h2>
                <p className="text-gray-700 my-4">
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">3. User Content</h2>
                <p className="text-gray-700 my-4">
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">4. Limitation of Liability</h2>
                <p className="text-gray-700 my-4">
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">5. Indemnification</h2>
                <p className="text-gray-700 my-4">
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">6. Governing Law & Jurisdiction</h2>
                <p className="text-gray-700 my-4">
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">7. Changes to These Terms</h2>
                <p className="text-gray-700 my-4">
