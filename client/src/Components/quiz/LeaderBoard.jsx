    ...
    const fetchData = async () => {
      try {
        ...
        const checkTest = await axios.get(
          `https://writo-education-frontend.onrender.com/api/quiz/check-quiz/${userId}/${id}`
        )
        ...
        if (checkTest.data.taken) {
          ...
          const resultResponse = await axios.get(
            `https://writo-education-frontend.onrender.com/api/quiz/test-results/${userId}/${id}`
          )
          ...
          const leaderboardResponse = await axios.get(
            `https://writo-education-frontend.onrender.com/api/quiz/leader-board/${id}/${userId}`
          )
                      ...
                      <div key={index} className="mb-4">
                        ...
                        <div className="space-y-2">
                          {[
                            ...
                            <div
                              key={idx}
                              className={`p-2 rounded ${getOptionClass(
                                option,
