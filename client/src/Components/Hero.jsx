...
const Hero = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      }}
    >
      <div className="absolute inset-0 bg-black opacity-60  h-full"></div>
      <div className="relative z-10 text-center text-white p-4  mt-6">
        <h1 className="md:text-5xl text-3xl font-bold mb-4 mt-32">
          Welcome to Writo Mentorship
        </h1>
        ...
        <div className="mb-8 md:flex-row md:justify-center flex flex-col items-center gap-12">
          <Link to="./book_mentor">
            <a
              href="#book-trial"
              className="bg-[#41c396] text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-green-700 transition duration-300"
            >
        ...
        <div className="flex flex-col items-center md:flex-row md:flex-wrap md:justify-center md:space-x-8 gap-3 mt-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3">
            ...
            <div className="flex items-center mb-2 md:mb-0 ml-[27px] md:ml-0">
              <svg
                className="w-6 h-6 mr-2 text-blue-600"
                fill="none"
                stroke="currentColor"
