    ...
    return (
        <div>
            ...
            <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md my-6">
                <h1 className="text-center text-3xl font-bold mb-6 text-[#184948]">Privacy Policy</h1>
                <p className="text-gray-600 mb-6">Effective Date: [Insert Date]</p>

                <h2 className="text-xl font-semibold text-[#184948] mt-4">1. Introduction</h2>
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">2. Information We Collect</h2>
                ...
                <ul className=" list-inside text-gray-700 mb-4">
                    ...
                    <li><strong>Cookies:</strong> We use cookies to enhance your experience on our site. For more information, please refer to our <a href="/cookie-policy" className="text-[#184948] underline">Cookie Policy</a>.</li>
                </ul>

                <h2 className="text-xl font-semibold text-[#184948] mt-4">3. How We Use Your Information</h2>
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">4. How We Share Your Information</h2>
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">5. Your Rights</h2>
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">6. Data Security</h2>
                <p className="text-gray-700 my-4">
                ...
                <h2 className="text-xl font-semibold text-[#184948] mt-4">7. Changes to This Policy</h2>
                <p className="text-gray-700 my-4">
                    We may update this privacy policy from time to time. We will notify you of any changes by posting the new policy on this page.
                </p>

                <h2 className="text-xl font-semibold text-[#184948] mt-4">8. Contact Us</h2>
                <p className="text-gray-700 my-4">
