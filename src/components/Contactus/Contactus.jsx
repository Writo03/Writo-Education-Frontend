...
const Contactus = () => {
  ...
  return (
    <div className="mx-auto ">
      ...
      <div className="bg-gray-100 px-6 py-6 rounded-md shadow-md text-lg font-medium">
      ...
      <div className="flex flex-col">
        ...
        <div>
                  ...
                  <div className="w-full lg:w-1/3 mr-4">
                    <div className="font-serif">
                      ...
                      <p className="text-sm lg:text-base leading-relaxed mt-4">
                        <p className="pt-2">
                          At Write Education, we’re passionate about
                        </p>
                        <p className="pt-2">
                          empowering JEE/NEET aspirants to reach{" "}
                        </p>
                        <p className="pt-2">
                          their full potential. Our team is committed to
                        </p>
                        <p className="pt-2">
                          providing you with the best learning
                        </p>
                        <p className="pt-2">experience possible.</p>
                      </p>
                    </div>
                  </div>
          ...
          <div className="bg-teal-900 w-full p-2 text-white">
